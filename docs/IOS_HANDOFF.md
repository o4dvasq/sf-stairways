...
The zip contains source files only — no .xcodeproj. The Xcode project was created manually and lives at `~/Desktop/SFStairways/`. The following were configured manually in Xcode and would need to be reconfigured if the project is recreated:
